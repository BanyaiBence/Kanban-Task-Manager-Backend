...
public class BoardController {
    ...
    public ResponseEntity<BoardResponse> createBoard(
        ...
        BoardResponse createdBoard = boardService.createBoard(request, userDetails.getUsername());
    ...
    public ResponseEntity<List<BoardResponse>> getUserBoards(
            @AuthenticationPrincipal UserDetails userDetails) {
        List<BoardResponse> boards = boardService.getUserBoards(userDetails.getUsername());
